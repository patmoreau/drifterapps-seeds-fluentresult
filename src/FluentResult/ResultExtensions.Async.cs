...
{
    /// <summary>
    /// Provides asynchronous extension methods for converting tasks into results and handling them through matching and transformation.
    /// </summary>
    public static partial class ResultExtensions
    {
        /// <summary>
        /// Converts a task of type <typeparamref name="T"/> into a successful result unless <typeparamref name="T"/> is <see cref="ResultError"/>.
        /// </summary>
        ...
        /// <summary>
        /// Executes the next function if the result is successful, passing the result value to the next function and returning a result of type TOut.
        /// </summary>
        /// <typeparam name="T">The type of the input result value.</typeparam>
        /// <param name="resultTask">The task that returns a result of type TIn.</param>
